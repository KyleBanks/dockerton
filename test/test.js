...
describe('Dockerton', function() {
     ...
     * runImage
     */
    it('runImage: successfully runs a simple image', function(done) {
        var d = _new()
            .from('hello-world');
    ...
    it('runImage: by default, directs output to `console.log`', function(done) {
        this.timeout(60000);
    ...
    it('runImage: allows custom stdout listeners', function(done) {
        this.timeout(60000);
    ...
    it('runImage: by default, directs error output to `console.error`', function(done) {
        this.timeout(60000);
    ...
    it('runImage: allows custom stderr listeners', function(done) {
        this.timeout(60000);
